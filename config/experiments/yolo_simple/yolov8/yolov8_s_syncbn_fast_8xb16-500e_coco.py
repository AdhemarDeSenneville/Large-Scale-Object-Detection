...
# -----data related-----
data_root = '/home/adhemar/Bureau/datasets/Methanizers/res_100cm/'  # Root path of data
# Path of train annotation file
train_ann_file = 'annotation/train.json'
train_data_prefix = 'train/images'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotation/val.json'
val_data_prefix = 'val/images'  # Prefix of val image path

num_classes = 3  # Number of classes for classification
class_name = ('all', 'tank', 'pile')
metainfo = dict(classes=class_name, palette=[(20, 220, 60), (0, 150, 136), (255, 140, 0)])
