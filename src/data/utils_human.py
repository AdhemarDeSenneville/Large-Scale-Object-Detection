...
def annotate_positions(
    ...
    def show_image(idx, center_xy=None):
        ...
        print('POSITIONS', x, y, '| GPS', *reversed(Transformer.from_crs(crs, "EPSG:4326", always_xy=True).transform(x, y)))
        ...
        if False:
            ...
            img_array = dataset.get_image_from_centre((x, y), window_size=window_size)
            img_array = np.array(img_array['image'])
